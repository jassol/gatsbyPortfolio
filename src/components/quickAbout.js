...
const QuickAbout = () => (
  <div>
    ...
    <div
      ...
      <p> Unprofessionally, I love backpacking, board games and interior design. Also, dessert. Seriously. If you want to know the best donut place in NYC, let's talk.</p>
      {/* TODO fix this resume link to serve up resume */}
      {/* <a href="./assets/Jasmin.Soltani.pdf" target="_blank" >
        <div>resum&eacute;</div>
      </a> */}
      <Button link={"Jasmin.Soltani.pdf"} text={'resumé'} />
    </div>
